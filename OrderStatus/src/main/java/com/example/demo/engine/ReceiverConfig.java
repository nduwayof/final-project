...
public class ReceiverConfig {
    ...
    public ConsumerFactory<String, Payment> consumerFactory2() {
        ...
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        JsonDeserializer jsonDeserializer = new JsonDeserializer<Payment>(Payment.class);
        jsonDeserializer.addTrustedPackages("*");
        return new DefaultKafkaConsumerFactory<String, Payment>(config, new StringDeserializer(), jsonDeserializer);
    }
