...
containerID := $(shell docker ps -a -q --filter ancestor=ahmedheshamafify/payment-service:latest)
...
#===================  docker  ===========================
docker-build:
	docker build -t ahmedheshamafify/payment-service:latest .


docker-run: docker-build
	docker run -p 8080:8080 ahmedheshamafify/payment-service:latest
...
docker-push: docker-login docker-build
	docker push ahmedheshamafify/payment-service:latest

docker-bash:
	docker exec -ti ahmedheshamafify/payment-service:latest /bin/sh
